...
class Drip_Connect_Block_Adminhtml_System_Config_Sync_Orders
    extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
     * Set template to itself
     *
     * @return Drip_Connect_Block_Adminhtml_System_Config_Sync_Orders
     */
    protected function _prepareLayout()
    {
        parent::_prepareLayout();
        if (!$this->getTemplate()) {
            $this->setTemplate('drip/connect/config/sync/orders.phtml');
        }
        return $this;
    }
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $this->addData(array(
            ...
            'ajax_url' => Mage::getSingleton('adminhtml/url')->getUrl('adminhtml/config_sync_orders/run'),
    ...
    public function isSyncAvailable()
    {
        ...
        $syncState = Mage::getStoreConfig('dripconnect_general/actions/sync_orders_data_state', Mage::app()->getRequest()->getParam('store'));
